...
int main(int argc, char** argv) {
    ...
    dsr_linkcache_add_link(n_1, n_2, 100);
    dsr_linkcache_add_link(n_3, n_5, 100);
    dsr_linkcache_add_link(n_4, n_1, 100);
    dsr_linkcache_add_link(n_4, n_5, 100);
    dsr_linkcache_add_link(n_5, n_3, 100);
    ...
    dsr_linkcache_run_dijkstra(n_1);

    int len = dsr_linkcache_get_shortest_path(n_1, n_4, &path);
    int i;

    for(i = 0; i < len; i++) {
        printf("\thop [%d] " MAC "\n", i, EXPLODE_ARRAY6(path->address + (i * ETHER_ADDR_LEN)));
    }
    ...
    dsr_linkcache_add_link(n_5, n_3, 100); /* double add */
    printf("first add done");
    dsr_linkcache_add_link(n_5, n_3, 100);
    printf("double add done");
    dsr_linkcache_remove_link(n_3, n_5);
    dsr_linkcache_run_dijkstra(n_1);

    len = dsr_linkcache_get_shortest_path(n_1, n_6, &path);
    ...
    dsr_linkcache_remove_link(n_5, n_3); /* double remove */
    dsr_linkcache_remove_link(n_5, n_3);
    ...
    len = dsr_linkcache_get_shortest_path(n_1, n_2, &path);
    ...
    dsr_linkcache_remove_link(n_1, n_2);
    dsr_linkcache_run_dijkstra(n_1);
    ...
    dsr_linkcache_add_link(n_4, n_5, 100);
    dsr_linkcache_add_link(n_4, n_1, 100);
    dsr_linkcache_remove_link(n_4, n_1);
    dsr_linkcache_add_link(n_4, n_5, 100);
    dsr_linkcache_add_link(n_5, n_6, 100);
    dsr_linkcache_remove_link(n_6, n_2);
    dsr_linkcache_remove_link(n_4, n_1);
