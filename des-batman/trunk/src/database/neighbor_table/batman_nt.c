...
int batman_db_neighbor_entry_create(uint8_t ether_neighbor_addr[ETH_ALEN],
                                    const uint8_t ether_iface_addr[ETH_ALEN], batman_neighbor_entry_t** entry_out) {
